...
<!-- Header menu bar -->
	...
	<div class="container">
		...
		<br> <input oninput="w3.filterHTML('#id01', '.item', this.value)"
			placeholder="Search User" style="width: 22%;"
			class=" w3-input w3-round-xlarge w3-border-yellow w3-mobile"><br>
	<!-- User list table -->
		<table border="1" class="w3-table w3-bordered w3-white  w3-opacity"
			id="id01">
			<tr class="item">
			...
			<!-- Getting the database connection and user details from the database -->
			<%
			try {
